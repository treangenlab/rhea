## function to convert sequences from the Mum & Co VCF output into a fasta

import argparse
import pandas as pd


parser = argparse.ArgumentParser(description='Extract SV information from Mum&Co output VCF')
parser.add_argument('VCF_files', nargs="+", help='Path to the Mum&Co VCF file')
